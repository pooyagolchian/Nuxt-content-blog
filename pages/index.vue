<template>
  <div class='row m-0'>
    ...
    <div class='col-12 col-sm-12 col-md-4 project pb-50'>
      ...
      <a class='app-title d-flex flex-row pt-2 pb-2' href='https://www.npmjs.com/package/vue-js-star-rating'
         target='_blank'>VUE.js icon rating NPM package</a>
      <a class='app-title d-flex flex-row pt-2 pb-2' href='https://github.com/pooyagolchian/pooyagolchian.github.io'
